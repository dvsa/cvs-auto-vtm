...
public class TestRecordPage extends GenericPage {
    ...
    private static final String VEHICLE_SECTION = "#accordion-default-content-Vehicle";;
    private static final String TEST_SECTION = "accordion-default-content-Test";
    private static final String EMISSIONS_DETAILS_SECTION = "accordion-default-content-Emissions\\ details";
    private static final String VISIT_SECTION = "#accordion-default-content-Visit";
    private static final String NOTES_SECTION = "#accordion-default-content-Notes";
    private static final String TEST_RECORD_HISTORY_SECTION = "#accordion-default-content-Test\\ record\\ history";
    ...
    public void checkOdometerReadingValue() {
        Assert.assertTrue("Expected value '" + odometerReading + "' for 'odometerReading' is not contained in '"
                + getDriver().findElement(By.cssSelector(ODOMETER_READING)).getText() + "'",
                getDriver().findElement(By.cssSelector(ODOMETER_READING)).getText().contains(odometerReading));
    ...
    public void checkNumberOfEntriesInSection(String section, int numberOfEntries) {
        ...
        if (option.contentEquals("test record history")) {
            Assert.assertEquals("Expected number of entries '" + numberOfEntries + "' differs than actual number '" +
                            getDriver().findElements(By.cssSelector(TEST_RECORD_HISTORY_SECTION)).size() + "'",
                    numberOfEntries, getDriver().findElements(By.cssSelector(TEST_RECORD_HISTORY_SECTION)).size());
        }
        else {
    ...
    public void expandSection(String section) {
        if (findElementByXpath("//span[text() = '" + section + "']").isDisplayed()) {
            if (findElementByXpath("//span[text() = '" + section + "']/following-sibling::button")
                ...
                findElementByXpath("//span[text() = '" + section + "']/following-sibling::span").click();
            }
            else {
    ...
    public void checkSectionIsPresent(String section) {
        ...
        switch (option) {
            case "vehicle":
                wait.until(ExpectedConditions.presenceOfElementLocated(By.cssSelector("#accordion-default>:nth-child(2)")));
                wait.until(ExpectedConditions.visibilityOfElementLocated(By.cssSelector("#accordion-default>:nth-child(2)")));
                break;
            case "test":
                wait.until(ExpectedConditions.presenceOfElementLocated(By.cssSelector("#accordion-default>:nth-child(3)")));
                wait.until(ExpectedConditions.visibilityOfElementLocated(By.cssSelector("#accordion-default>:nth-child(3)")));
                break;
            case "defects":
                wait.until(ExpectedConditions.presenceOfElementLocated(By.cssSelector("#accordion-default>:nth-child(4)")));
                wait.until(ExpectedConditions.visibilityOfElementLocated(By.cssSelector("#accordion-default>:nth-child(4)")));
                break;
            case "seatbelt installation check":
                wait.until(ExpectedConditions.presenceOfElementLocated(By.cssSelector("#accordion-default>:nth-child(5)")));
                wait.until(ExpectedConditions.visibilityOfElementLocated(By.cssSelector("#accordion-default>:nth-child(5)")));
                break;
            case "emission details":
                wait.until(ExpectedConditions.presenceOfElementLocated(By.cssSelector("#accordion-default>:nth-child(6)")));
                wait.until(ExpectedConditions.visibilityOfElementLocated(By.cssSelector("#accordion-default>:nth-child(6)")));
                break;
            case "visit":
                wait.until(ExpectedConditions.presenceOfElementLocated(By.cssSelector("#accordion-default>:nth-child(7)")));
                wait.until(ExpectedConditions.visibilityOfElementLocated(By.cssSelector("#accordion-default>:nth-child(7)")));
                break;
            case "notes":
                wait.until(ExpectedConditions.presenceOfElementLocated(By.cssSelector("#accordion-default>:nth-child(8)")));
                wait.until(ExpectedConditions.visibilityOfElementLocated(By.cssSelector("#accordion-default>:nth-child(8)")));
                break;
            case "test record history":
                wait.until(ExpectedConditions.presenceOfElementLocated(By.cssSelector("#accordion-default>:nth-child(9)")));
                wait.until(ExpectedConditions.visibilityOfElementLocated(By.cssSelector("#accordion-default>:nth-child(9)")));
                break;
            default:  // should be unreachable!
                throw new AutomationException(
                        "Invalid test record section '" + option + "'");
    ...
    public void checkSectionIsNotPresent(String section) {
        ...
        switch (option) {
            case "vehicle":
                wait.until(ExpectedConditions.invisibilityOfElementLocated(By.cssSelector("#accordion-default>:nth-child(2)")));
                break;
            case "test":
                wait.until(ExpectedConditions.invisibilityOfElementLocated(By.cssSelector("#accordion-default>:nth-child(3)")));
                break;
            case "defects":
                wait.until(ExpectedConditions.invisibilityOfElementLocated(By.cssSelector("#accordion-default>:nth-child(4)")));
                break;
            case "seatbelt installation check":
                wait.until(ExpectedConditions.invisibilityOfElementLocated(By.cssSelector("#accordion-default>:nth-child(5)")));
                break;
            case "emission details":
                wait.until(ExpectedConditions.invisibilityOfElementLocated(By.cssSelector("#accordion-default>:nth-child(6)")));
                break;
            case "visit":
                wait.until(ExpectedConditions.invisibilityOfElementLocated(By.cssSelector("#accordion-default>:nth-child(7)")));
                break;
            case "notes":
                wait.until(ExpectedConditions.invisibilityOfElementLocated(By.cssSelector("#accordion-default>:nth-child(8)")));
                break;
            case "test record history":
                wait.until(ExpectedConditions.invisibilityOfElementLocated(By.cssSelector("#accordion-default>:nth-child(9)")));
                break;
            default:  // should be unreachable!
                throw new AutomationException(
                        "Invalid test record section '" + option + "'");

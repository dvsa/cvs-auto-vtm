...
public class GenericPage extends PageObject {
    ...
    public void checkFieldEditable(String field) {
        ...
        Assert.assertNull("Element with id 'test-" + field + "' has the 'disabled' attribute and it should not",
                element.getAttribute("disabled"));
    }

    public void checkFieldNotEditable(String field) {
        WebElement element = getDriver().findElement(By.id("test-" + field));
        Assert.assertNotNull("Element with id 'test-" + field + "' does not have the 'disabled' attribute and it should",
                element.getAttribute("disabled"));
    }
    ...
    public void setValueForField(String field, String value) {
        WebElement element = getDriver().findElement(By.cssSelector("[id^=test-" + field +"]"));
        String tagName;

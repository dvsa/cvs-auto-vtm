Feature: Search tech record
  ...
  AC8 - "-" is displayed, when an attribute has a value of 'null' or space within DynamoDB
    ...
    Then tech record fields should have values
      ...
      | notes                               | notes        |
      | testCode-tRes-0-tType-0             | Aav2         |
      | testTypeEndTimestamp-tRes-0-tType-0 | 17/01/2019   |
      ...
      | testCode-tRes-1-tType-0             | Aav2         |
      | testTypeEndTimestamp-tRes-1-tType-0 | 18/10/2019   |
      | expiryDate-tRes-1-tType-0           | 30/01/2019   |
      | certificateNumber-tRes-1-tType-0    | 12343489     |
      | testResult-tRes-1-tType-0           | FAIL         |
